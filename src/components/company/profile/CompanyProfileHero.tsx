    ...
    return (
        <section className="relative max-w-7xl mx-auto px-4 sm:px-6 mb-20 pt-8 group/hero">
             ...
             <div className="relative -mt-24 mx-4 md:mx-auto max-w-5xl z-10">
                <div className="bg-white rounded-3xl p-8 md:p-10 shadow-xl flex flex-col md:flex-row items-start gap-8 border border-slate-100 relative group/card">
                  ...
                  <div className="relative shrink-0 mx-auto md:mx-0 group/avatar">
                      <div className="w-32 h-32 md:w-40 md:h-40 rounded-full p-1 bg-slate-200 relative overflow-hidden">
                        {company.logoUrl ? (
                            <Image src={company.logoUrl} alt={company.name} width={160} height={160} className="w-full h-full rounded-full bg-white object-contain border-4 border-white" />
                        ) : (
                            <div className="w-full h-full rounded-full bg-white border-4 border-white flex items-center justify-center text-4xl font-bold text-slate-800">
                  ...
                  <div className="text-center md:text-left flex-1 w-full space-y-4">
                      <div>
                        {company.legalName && (
                            <p className="text-xl text-slate-500 font-bold mb-1">{company.legalName}</p>
                        )}
                        <h2 className="text-3xl font-bold text-slate-900 flex flex-wrap items-center justify-center md:justify-start gap-3">
                          {company.name}
                          {company.isVerified && (
                              <div className="relative group">
                                <ShieldCheck className="text-blue-500" size={32} fill="#dbeafe" />
                                <span className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2 py-1 bg-slate-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                                  Đã xác thực
                                </span>
                              </div>
                          )}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-slate-600 text-sm font-medium">
                        {company.location && (
                      ...
                      {/* Actions */}
                      <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-6 pt-4 border-t border-slate-100">
                        <CompanyFollowButton
                            companyId={company.id}
                            companySlug={company.slug}
                            variant="default"
                            size="lg"
                            className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-6 shadow-lg shadow-blue-600/20 font-bold transition-all hover:scale-105 active:scale-95 border-0"
                        />
                        <CompanyMessageButton 
                            ...
                            variant="secondary"
                            size="lg"
                            className="rounded-full px-6 font-bold bg-slate-100 text-slate-900 hover:bg-slate-200 transition-all hover:scale-105 active:scale-95 border-0"
                        >
