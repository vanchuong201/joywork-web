...
export function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {open && (
        <div className="w-[360px] h-[520px] rounded-2xl border border-[var(--border)] bg-[var(--background)] shadow-2xl flex flex-col overflow-hidden">
          {/* Header */}
      ...
      <button
        ...
        aria-label={open ? "Đóng chat" : "Mở chat tìm việc"}
      >
